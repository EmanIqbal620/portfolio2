...
function ProjectCard({ project, index }: { project: WorkProject; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col overflow-hidden rounded-xl border border-white/[0.08] bg-surface-overlay shadow-[0_2px_4px_rgba(0,0,0,0.4),0_8px_32px_rgba(148,99,194,0.08),0_8px_32px_rgba(0,0,0,0.12)] transition-[transform,border-color,box-shadow] duration-500 ease-out hover:-translate-y-1.5 hover:border-accent/60 hover:shadow-[0_4px_12px_rgba(0,0,0,0.4),0_20px_56px_rgba(148,99,194,0.2),0_20px_56px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(148,99,194,0.08)] h-full group will-change-transform"
    >
      <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-accent/50 via-accent/25 to-accent/5 transition-all duration-500 ease-out group-hover:w-[4px] group-hover:from-accent group-hover:via-accent/50 group-hover:to-accent/10 group-hover:shadow-[2px_0_12px_rgba(148,99,194,0.15)]" />
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          {project.links.demo && project.links.demo !== '#' && (
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-3 text-xs font-semibold rounded-lg bg-accent/90 backdrop-blur-sm text-white shadow-[0_4px_20px_rgba(148,99,194,0.2)] transition-all duration-300 hover:bg-accent hover:shadow-[0_8px_32px_rgba(148,99,194,0.3)] hover:-translate-y-0.5 active:scale-95 min-h-[44px] group"
            >
        ...
        {filteredProjects.length > 0 && hasMore && !showAll && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="group inline-flex items-center gap-3 px-7 py-4 rounded-xl border border-white/[0.1] bg-surface-overlay text-sm font-semibold text-[var(--text-body)] hover:text-white hover:border-accent/40 hover:bg-accent/[0.06] hover:shadow-[0_8px_32px_rgba(148,99,194,0.12)] transition-all duration-300 ease-out"
            >
