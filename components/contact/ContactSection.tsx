    ...
    <section id="contact" className="section-alt relative py-20 md:py-28 px-4 sm:px-6 overflow-hidden scroll-mt-20">
      ...
      <div className="max-w-lg mx-auto relative z-10 text-center">
        ...
        >
              ...
              <div className="w-12 h-12 rounded-xl bg-accent-subtle text-accent flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-accent-soft group-hover:scale-105 group-hover:shadow-[0_0_16px_rgba(148,99,194,0.15)]">
                <Mail className="w-5 h-5" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-caption font-semibold text-[var(--text-muted)] tracking-wide uppercase mb-0.5">Email</p>
                <p className="text-body-sm font-medium text-white truncate">emaniqbal907@gmail.com</p>
              </div>
              <button
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-body-sm font-medium text-white truncate">linkedin.com/in/eman-iqbal</p>
              </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-body-sm font-medium text-white truncate">github.com/EmanIqbal620</p>
              </div>
              <span className="flex-shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-white/[0.12] text-xs font-semibold text-white/50 group-hover:text-white group-hover:border-white/25 transition-all">
                Open
                <ArrowUpRight className="w-3.5 h-3.5" />
